          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <!-- 方法参数第一个为遍历后的颜色和版本的每一个数据  第二个为颜色和版本总共的数据-->
              </dl>
            ...
            <div class="cartWrap">
              ...
              <!-- 以前咱们的路由跳转,从A路由跳转到B路由,这里在加入购物车之前,进行路由跳转之前,发请求
                把你要购买的产品的信息通过请求的形式通知服务器,服务器进行相应的存储 -->
...
export default {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      //2:服务器存储成功---进行路由跳转
      //3:失败,给用户进行提示
      // 当前这里派发一个action,也向服务器发起请求,判断加入购物车是成功还是失败了,进行相应的操作
